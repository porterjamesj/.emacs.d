...
(use-package ibuffer
  ...
  :config
  ;; hide some buffer groups; from the wiki:
  ;; https://www.emacswiki.org/emacs/IbufferMode#toc12
  (setq jjp/ibuffer-collapsed-groups (list "Emacs" "Magit"))

  (advice-add 'ibuffer :after #'jjp/collapse-ibuffer-groups)

  (defun jjp/collapse-ibuffer-groups (&optional arg)
    (dolist (group jjp/ibuffer-collapsed-groups)
      (progn
        (goto-char 1)
    ...
    (goto-char 1) (search-forward "[ " (point-max) t)))
